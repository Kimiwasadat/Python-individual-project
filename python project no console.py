...
def am():
    ...
    startminutetime = int(time_am_min)
    if time_in_am == False:
        pm_text.config(text="")
        time_in_am = True
    else:
    ...
    while importantLoop == True:
        ...
        if add_websites_to_hosts == True:
            ...
            if stop_time == True and start_time == True:
                ...
                if current_time.hour == int(starthourtime) and current_time.minute == startminutetime:
        ...
        while check_if_time_is_up == True:
            if check_if_time_is_up == True:
                ...
                application_killer()
                if current_time.hour == int(stophourtime) and current_time.minute == int(stopminutetime):
